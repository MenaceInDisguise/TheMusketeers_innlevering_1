...
def beslutningspunkt1():
    ...
    avsnitt()
    svar = sjekkSvar("(a) Erlend velger å møte utfordringene med åpenhet og empati ved å samle teamet til et møte.  I dette møtet får Silje og Sivert mulighet til å uttrykke synspunktene sine og misforståelsene sine. (b) Erling bestemmer scopet til medborgerportalen selv, utfallet blir at Siveret og Silje ender opp på dårlig fot med hverandre, uro og stress tar over arbeidsmiljøet.")
    return svar
...
introduksjon()
avsnitt()
b1 = beslutningspunkt1() #Kaller funksjonen for beslutningspunkt 1 og lagrer svaret i en variabel.
